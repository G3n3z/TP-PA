...
import pt.isec.pa.apoio_poe.model.Exceptions.*;
...
public class OpcoesCandidatura extends StateAdapter{
    ...
    public boolean close() throws StateNotClosed {
        ...
        throw new StateNotClosed("Fase anterior ainda aberta.");
    }
    ...
    public void addPropostaACandidatura(long nAluno, String idProposta) throws InvalidArguments {
        ...
        if(a == null){
            throw new InvalidArguments("Numero de aluno não existente");
        }
        if(!a.temCandidatura()){
    ...
    public void removePropostaACandidatura(String id, long naluno) throws InvalidArguments {
        if(!data.verificaProposta(id)){
            throw new InvalidArguments("Nao existe o id inserido");
        }
        Aluno a = data.getAluno(naluno);
        if(a == null){
            throw new InvalidArguments("Nao existe nenhum aluno com este numero inserido");
        }
        if(!a.temCandidatura()){
