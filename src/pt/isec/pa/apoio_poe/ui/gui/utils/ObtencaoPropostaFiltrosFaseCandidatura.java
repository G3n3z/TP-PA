...
public class ObtencaoPropostaFiltrosFaseCandidatura extends VBox {
    ModelManager model;
    ...
    public ObtencaoPropostaFiltrosFaseCandidatura(ModelManager model) {
        this.model = model;
        createViews();
    }
    ...
    private void preparaFiltros() {
        ...
        ckPropCandidaturas = new CheckBox("Propostas Com candidaturas");
        ckPropCandidaturas.setMinWidth(100);
        ckPropSemCandidatura = new CheckBox("Propostas sem Candidaturas");
...
//        if (Arrays.stream(opcoes).allMatch( o -> o == 0)){
//            return null;
//        }
        return opcoes;
    }
